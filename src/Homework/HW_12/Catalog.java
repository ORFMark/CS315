...
public class Catalog {
	public static void run(String[] args) {
		...
		list.add(new Item("Certified Organic Rubber Garden Hose", 18.75, 4.1));
		...
		list.add(new Item("US Army Standard Issue Garden Hose", 109.42, 3.0));
		list.add(new Item("Prank garden hose", 9.99, 4.7));
		list.add(new Item("Chinese Floral Print garden Hose", 0.99, 0.2));
		// print list as added
